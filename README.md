...
test jenkins build after adding domain
...
### `npm test` fails on macOS Mojave

If you run 'npm test' and it just fails to run then it may be again be an issue with watchman.

It is recommended to reinstall watchman:
